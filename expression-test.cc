...
int main()
{
  Expression e1{new Plus{new Integer{3},new Real{3.14}}};  // defaultkonstruktor
  ...
  // Resten krॊver implementering av Expression_Tree-klasserna.


  Expression_Tree* t{new Plus{new Integer{7}, new Real{3.14}}};

  Expression e3{t};  // konstruktor som tar ett lॊnkat uttryckstrॊd
